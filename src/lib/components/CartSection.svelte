...
<section class="rounded-xl bg-white p-6">
	...
	{#each $desserts as dessert, index}
		{#if dessert.quantity > 0}
			<div class="flex items-center justify-between border-b-[0.2px] border-rose-400 py-3 text-sm">
				<div>
  ...
  <div class="my-5 flex items-center justify-between">
	...
	<button class="bg-red w-full rounded-4xl py-3 text-lg font-semibold text-rose-100"
